...
// export const setInWallMeasurementText = (wall: WallMetaData, objectMetas: ObjectMetaData[]) => {
...
// export const updateMeasurementText = (wallMeta: WallMetaData[]) => {
// 	const { downWalls, upWalls } = buildWallMeasurementData(wallMeta);

// 	// if (shift == 5) $('#boxRib').empty();

// 	upWalls.forEach((upWallArray) => {
// 		addWallMeasurementsToScene(upWallArray, wallMeta, 5);
// 	});
// 	downWalls.forEach((downWallArray) => {
// 		addWallMeasurementsToScene(downWallArray, wallMeta, 5);
// 	});
// };
...
// export const buildWallMeasurementData = (
// 	wallMeta: WallMetaData[]
